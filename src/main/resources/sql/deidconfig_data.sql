...
insert  into `deidconfig`(`delflag`,`value`,`xpath`,`category`) values (0,'11111111','/:ClinicalDocument/:component/:structuredBody/:component/:section[:title/text()=\'Insurance Providers\']/:text/:table/:tbody/:tr/:td[4]','ID');
insert  into `deidconfig`(`delflag`,`value`,`xpath`,`category`) values (0,'G11111111','/:ClinicalDocument/:component/:structuredBody/:component/:section[:title/text()=\'Insurance Providers\']/:text/:table/:tbody/:tr/:td[5]','ID');
insert  into `deidconfig`(`delflag`,`value`,`xpath`,`category`) values (0,'REDACTED','/:ClinicalDocument/:component/:structuredBody/:component/:section[:title/text()=\'Insurance Providers\']/:text/:table/:tbody/:tr/:td[6]','Name');
